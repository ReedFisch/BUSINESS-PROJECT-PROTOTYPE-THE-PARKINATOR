...
// The user reports overlap with "light gray lines" (service roads).
// We will push the rows very far apart.
const AISLE_START = { lat: 42.25252, lng: -73.79765 };
const AISLE_END = { lat: 42.25275, lng: -73.79752 };

// Increased to 14.0 meters to guarantee clearance of any central road/path
const AISLE_WIDTH_METERS = 14.0;
